...
plt.plot(x, TCT, label = '$\mathrm{E}[T]$')
plt.plot(x9, y9, label = '$\mathrm{E}[T_H]$ $α=0.9$')
# plt.plot(x8, y8, label = 'Priority $\lambda = 0.8$')
# plt.plot(x7, y7, label = 'Priority $\lambda = 0.7$')
# plt.plot(x6, y6, label = 'Priority $\lambda = 0.6$')
# plt.plot(x5, y5, label = 'Priority $\lambda = 0.5$')
